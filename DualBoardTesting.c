...
#define	SPICS	RPI_GPIO_P1_15	//P3 Select ADC Board 1
#define	SPICS1	RPI_GPIO_P1_16	//P4 Select ADC Board 2
		...
		while(1)
		{
			...
			{	
				...
				if( c == 7 )
				{
					...
					fprintf(dataLog, "Time:%f, %f, %f, %f, %f, %f\n", currentTime, floatVoltage[1], floatVoltage[2], floatVoltage[3], floatVoltage[4], floatVoltage[5]);
					fflush(dataLog);
				}
				else
				{
